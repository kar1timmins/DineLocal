  ...
  'inline-flex items-center justify-center rounded-md border px-2 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-error/20 dark:aria-invalid:ring-error/40 aria-invalid:border-error transition-[color,box-shadow] overflow-hidden',
  {
    variants: {
      variant: {
        ...
        error: 'border-transparent bg-error text-error-foreground [a&]:hover:bg-error/90',
        warning: 'border-transparent bg-warning text-warning-foreground [a&]:hover:bg-warning/90',
        secondary:
          'border-transparent bg-secondary text-secondary-foreground [a&]:hover:bg-secondary/90',
        'secondary-primary':
          'bg-primary-50 border-transparent text-primary [a&]:hover:bg-primary/90',
        'secondary-success':
          'bg-success-50 border-transparent text-success-600 [a&]:hover:bg-success/90',
        'secondary-error': 'bg-error-50 border-transparent text-error [a&]:hover:bg-error/90',
        'secondary-warning':
          'bg-warning-50 border-transparent text-warning-600 [a&]:hover:bg-warning/90',
        destructive:
